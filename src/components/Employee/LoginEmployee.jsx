...
import loginpic from 'C:/Users/kusampudi.pavan/React Projects/employeefrontend/src/assets/Employee.png'
...
function LoginEmployee() {
  ...
  function SubmitHandler(sh) {
    sh.preventDefault();
    axios.post("http://localhost:8084/Employee/authenticatetoken", {
      email: email,
      password: password
    }).then(res => {
      ...
      <div className="wrapper-inner-signup">
        <div className="row">
          <center>
            ...
            <h3 style={{marginTop:"0px",fontStyle:"oblique"}}><center>Employee Login</center></h3>
              <div className='col'>
                <img src={loginpic} width="300px" height="230px" alt='error' className='img-login'></img>
              </div><br />
              <div className='col'>
                <div>
