...
import loginpic from 'C:/Users/kusampudi.pavan/React Projects/employeefrontend/src/assets/AdminLogin.jpg'
            ...
            <div className="wrapper-inner-signup" >
                <div className="row">
                    <center>
                        ...
                        <h3 style={{fontStyle:"oblique"}}><center>Admin Login</center></h3>
                            <div className='col'>
                                <img src={loginpic} width="350px" alt='error' className='img-login'></img>
                            </div><br />
                            <div className='col'>
                                <div>
                                    <form onSubmit={SubmitHandler}>
                                        <div className="mb-1">
                                            ...
                                            <input style={{width:"300px"}} type="email" name="email" value={email} className="form-control" placeholder="Enter email" onChange={formHandler} autoFocus />
                                        </div>
                                        <div className="mb-3">
